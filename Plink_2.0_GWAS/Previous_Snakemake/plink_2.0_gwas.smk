include: '/project/path/to/directory/Snakefile'
include: '/project/path/to/directory/Snakefile'
...
rule standardize_phenos:
    ...
    run:
        ...
        df[non_bin_cols] = df[non_bin_cols].path/to/nextflow/path/to/nextflow/path/to/nextflow/path/to/nextflow/path/to/nextflow/path/to/nextflow/path/to/nextflow/path/to/nextflow/path/to/nextflow/path/to/nextflow/apply(lambda x: (x - x.mean()) / x.std())
...
rule call_plink2_logistic:
    ...
    input:
        ...
        samples='{cohort_dir}/sample_list.txt',
        longrange='/project/path/to/directory/longrange_LD_hg' + config['build'] + '.bed'
    params:
...
rule make_meta_input_lifted2:
    ...
    run:
        ...
        print(df)
        df['SNP'] = df[['chrCHR', 'BP', 'A2', 'A1']].path/to/nextflow/path/to/nextflow/path/to/nextflow/path/to/nextflow/path/to/nextflow/path/to/nextflow/path/to/nextflow/path/to/nextflow/path/to/nextflow/path/to/nextflow/apply(lambda x: ':'.join(x.astype(str)), axis=1)
